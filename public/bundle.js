...
/***/ (function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Form = __webpack_require__(223);
	var SMS = __webpack_require__(224);

	var Main = React.createClass({
	  displayName: 'Main',


	  handleSend: function handleSend(message, mobileno) {
	    var that = this;
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(Form, { onSend: this.handleSend }),
	      React.createElement(
	        'div',
	        { className: 'footer' },
	        React.createElement(
	          'a',
	          { href: 'http://burstsms/com.au' },
	          'BURST SMS HOME'
	        )
	      )
	    );
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement('input', { className: 'main__mobileno', type: 'tel', name: 'mobileno', ref: 'mobileno', pattern: '^[0-9\\-\\+\\s\\(\\)]*$', maxLength: '14', required: 'required' }),
	          React.createElement('span', { className: 'validity' })
	        ),
	        React.createElement(
	          'div',
	          null,
	          ...
	          React.createElement('textarea', { className: 'main__message', placeholder: 'Hi, I can add up to 3 SMS of text here.', ref: 'message', rows: '11', cols: '50', maxLength: '480', required: true })
	        ),
	        React.createElement(
	          'div',
	          null,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  postSMS: function postSMS(message, no) {
	    return axios({
	      method: 'post',
	      url: SMS_URL,
	      data: {
